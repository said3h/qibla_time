...
void main() {
  testWidgets('Navigation shell renders expected tabs',
        ...
        home: Scaffold(
          ...
          bottomNavigationBar: NavigationBar(
            destinations: const [
              ...
              NavigationDestination(
                  icon: Icon(Icons.explore_outlined), label: 'Qibla'),
              NavigationDestination(
                  icon: Icon(Icons.auto_awesome_outlined), label: 'Tasbih'),
              NavigationDestination(
                  icon: Icon(Icons.volunteer_activism_outlined), label: 'Dua'),
              NavigationDestination(
                  icon: Icon(Icons.menu_book_outlined), label: 'Coran'),
            ],
          ),
        ),
      ),
