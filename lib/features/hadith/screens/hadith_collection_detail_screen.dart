...
class HadithCollectionDetailScreen extends ConsumerStatefulWidget {
  const HadithCollectionDetailScreen({
    super.key,
    required this.collectionKey,
    required this.collectionLabel,
    required this.collectionArabicLabel,
  });

  final String collectionKey;
  final String collectionLabel;
  final String collectionArabicLabel;

  @override
  ConsumerState<HadithCollectionDetailScreen> createState() =>
      _HadithCollectionDetailScreenState();
}

class _HadithCollectionDetailScreenState
    extends ConsumerState<HadithCollectionDetailScreen>
                  ...
                  child: hadithsAsync.when(
                    ...
                    error: (_, __) => Center(
                      child: Padding(
                        padding: const EdgeInsets.all(24),
                        child: Text(
                          context.l10n.hadithLibraryFiltersError,
                          style: GoogleFonts.dmSans(
                            fontSize: 14,
                            color: tokens.textPrimary,
                          ),
...
class _CollectionHadithCard extends StatelessWidget {
  const _CollectionHadithCard({
...
class _CollectionHadithActions extends StatelessWidget {
  const _CollectionHadithActions({
    required this.isFavorite,
    required this.onToggleFavorite,
    required this.onShare,
  });
