...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get settingsSectionPeriodMode => 'Режим менструации';
  ...
  @override
  String get settingsPeriodMode => 'Режим менструации';
  ...
  @override
  String get periodGuideTitle => 'Памятка о менструации';

  @override
  String get periodGuideAllowed => 'Разрешено';

  @override
  String get periodGuidePaused => 'Приостановлено';

  @override
  String get periodGuideNote => 'Важное примечание';

  @override
  String get periodGuideIntro =>
      'Эта памятка кратко напоминает, что обычно остается дозволенным и что приостанавливается во время менструации.';

  @override
  String get periodGuideAllowedDhikr => 'Зикр и поминание Аллаха';

  @override
  String get periodGuideAllowedDua => 'Дуа и личная мольба';

  @override
  String get periodGuideAllowedListenQuran => 'Слушать Коран';

  @override
  String get periodGuideAllowedReadTranslation => 'Читать перевод Корана';

  @override
  String get periodGuidePausedPrayer => 'Обязательная молитва';

  @override
  String get periodGuidePausedFasting => 'Обязательный пост';

  @override
  String get periodGuidePausedTawaf => 'Таваф вокруг Каабы';

  @override
  String get periodGuidePausedTouchQuran => 'Прикасаться к Корану напрямую';

  @override
  String get periodGuideNoteBody =>
      'Обязательные посты, пропущенные во время менструации, нужно восполнить позже.';
  ...
  @override
  String get purificationGuideTitle => 'Вуду и гусль';

  @override
  String get purificationGuideSubtitle =>
      'Руководство по ритуальной чистоте перед молитвой';

  @override
  String get purificationGuideIntro =>
      'Перед молитвой мусульманину может понадобиться ритуальное очищение. Две основные формы — это вуду, малое омовение, и гусль, полное ритуальное омовение. Это руководство простым языком объясняет, что означает каждое из них, когда оно нужно и как его совершать.';

  @override
  String get purificationGuideWuduTitle => 'Вуду';

  @override
  String get purificationGuideWuduBody =>
      'Что это:\nВуду — это малое ритуальное омовение перед салятом, когда нет большого осквернения.\n\nКогда оно нужно:\n• Перед молитвой, если у тебя нет действительного вуду.\n• После посещения туалета.\n• После нарушения состояния чистоты, например при выходе газа, глубоком сне или потере сознания.\n\nШаги вуду:\n1. Сделай намерение в сердце.\n2. Скажи Бисмиллях.\n3. Вымой руки 3 раза, обычно начиная с правой.\n4. Прополощи рот 3 раза.\n5. Очисти нос водой 3 раза.\n6. Вымой всё лицо 3 раза.\n7. Вымой руки до локтей 3 раза, начиная с правой, затем левую.\n8. Протри голову один раз влажными руками.\n9. Протри уши один раз.\n10. Вымой ноги до щиколоток 3 раза, начиная с правой, затем левую.\n\nВажные замечания:\n• Обычно каждую часть моют 3 раза, но одного раза достаточно для действительности.\n• Убедись, что вода хорошо доходит до всей нужной области.\n• Соблюдай правильный порядок.\n• Удали всё, что мешает воде попасть на кожу, например грязь или плотный слой на коже.';

  @override
  String get purificationGuideWuduWhatIsLabel => 'Что это';
  ...
  @override
  String get purificationGuideWuduWhenNeededLabel => 'Когда оно нужно';
  ...
  @override
  String get purificationGuideWuduStepsTitle => 'Шаги вуду';

  @override
  String get purificationGuideWuduStepsSubtitle =>
      'Обычно каждую омываемую часть моют 3 раза, но одного раза достаточно для действительности.';

  @override
  String get purificationGuideWuduNotesTitle => 'Важные замечания';

  @override
  String get purificationGuideWuduNoteModeration =>
      'Не нужно чрезмерно повторять и превращать вуду в затруднение.';
  ...
  String get purificationGuideWuduNoteOrder =>
      'Соблюдай правильный порядок от начала до конца.';
  ...
  @override
  String get purificationGuideWuduRepeatOnce => '1 раз';

  @override
  String get purificationGuideWuduRepeatThreeTimes => '3 раза';

  @override
  String get purificationGuideWuduStep1Title => 'Намерение';

  @override
  String get purificationGuideWuduStep1Body =>
      'Сделай в сердце намерение совершить вуду для молитвы.';

  @override
  String get purificationGuideWuduStep2Title => 'Бисмиллях';

  @override
  String get purificationGuideWuduStep2Body =>
      'Скажи Бисмиллях перед началом омовения.';

  @override
  String get purificationGuideWuduStep3Title => 'Вымыть руки';

  @override
  String get purificationGuideWuduStep3Body =>
      'Тщательно вымой обе руки, обычно начиная с правой.';

  @override
  String get purificationGuideWuduStep4Title => 'Прополоскать рот';

  @override
  String get purificationGuideWuduStep4Body =>
      'Хорошо прополощи рот, чтобы вода дошла внутрь.';

  @override
  String get purificationGuideWuduStep5Title => 'Очистить нос';

  @override
  String get purificationGuideWuduStep5Body =>
      'Мягко втягивай воду в нос и очищай его.';

  @override
  String get purificationGuideWuduStep6Title => 'Вымыть лицо';

  @override
  String get purificationGuideWuduStep6Body =>
      'Вымой всё лицо: от лба до подбородка и от уха до уха.';

  @override
  String get purificationGuideWuduStep7Title => 'Вымыть руки до локтей';

  @override
  String get purificationGuideWuduStep7Body =>
      'Сначала вымой правую руку, потом левую, включая локти.';

  @override
  String get purificationGuideWuduStep8Title => 'Протереть голову';

  @override
  String get purificationGuideWuduStep8Body =>
      'Проведи влажными руками по голове мягко, спереди назад.';

  @override
  String get purificationGuideWuduStep9Title => 'Протереть уши';

  @override
  String get purificationGuideWuduStep9Body =>
      'Протри уши той же влажностью, не набирая новую воду.';

  @override
  String get purificationGuideWuduStep10Title => 'Вымыть ноги до щиколоток';

  @override
  String get purificationGuideWuduStep10Body =>
      'Сначала вымой правую ногу, потом левую, обязательно включая щиколотки.';

  @override
  String get purificationGuideGhuslTitle => 'Гусль';

  @override
  String get purificationGuideGhuslBody =>
      'Что это:\nГусль — это полное ритуальное омовение после большого осквернения.\n\nКогда он обязателен:\n• После интимной близости.\n• После полового выделения.\n• После окончания менструации.\n• После окончания послеродового кровотечения.\n\nКак его совершать:\n1. Сделай намерение в сердце.\n2. Скажи Бисмиллях.\n3. Вымой руки и интимные части.\n4. Удали видимые нечистоты.\n5. Сделай вуду.\n6. Полей голову водой так, чтобы вода дошла до кожи головы.\n7. Вымой всё тело, начиная обычно с правой стороны, затем с левой, следя за тем, чтобы вода дошла до всех мест.\n\nВажное замечание:\nПолный гусль снимает большое осквернение. Если после него не произошло ничего, что нарушает вуду, можно молиться без отдельного нового вуду.';

  @override
  String get purificationGuideGhuslWhatIsLabel => 'Что это';
  ...
  @override
  String get purificationGuideGhuslWhenNeededLabel => 'Когда он нужен';
  ...
  @override
  String get purificationGuideGhuslStepsTitle => 'Шаги гусля';

  @override
  String get purificationGuideGhuslStepsSubtitle =>
      'У гусля нет фиксированного числа повторений, как у вуду. Главное, чтобы вода достигла всего тела, хотя некоторые части можно помыть больше одного раза в рекомендуемой форме.';

  @override
  String get purificationGuideGhuslValidityTitle =>
      'Полная форма и действительный минимум';

  @override
  String get purificationGuideGhuslValidityRecommended =>
      'Полная рекомендуемая форма следует способу, переданному в Сунне, шаг за шагом и с тщательностью.';

  @override
  String get purificationGuideGhuslValidityMinimum =>
      'Действительный минимум прост: намерение и вода, покрывающая всё тело.';

  @override
  String get purificationGuideGhuslNotesTitle => 'Важные замечания';

  @override
  String get purificationGuideGhuslNoteDrySpots =>
      'Убедись, что не осталось ни одного сухого участка.';

  @override
  String get purificationGuideGhuslNoteScalp =>
      'Проследи, чтобы вода хорошо дошла до кожи головы.';
  ...
  String get purificationGuideGhuslNoteSimplicity =>
      'Не усложняй его без необходимости.';

  @override
  String get purificationGuideGhuslBadgeEssential => 'Обязательно';

  @override
  String get purificationGuideGhuslBadgeRecommended => 'Рекомендуется';

  @override
  String get purificationGuideGhuslBadgeUntilClean => 'До чистоты';

  @override
  String get purificationGuideGhuslBadgeUsuallyThreeTimes => 'Часто 3 раза';
  ...
  @override
  String get purificationGuideGhuslStep1Title => 'Намерение';

  @override
  String get purificationGuideGhuslStep1Body =>
      'Сделай в сердце намерение удалить большое осквернение и совершить гусль.';

  @override
  String get purificationGuideGhuslStep2Title => 'Бисмиллях';
  ...
  @override
  String get purificationGuideGhuslStep3Title => 'Вымыть руки';

  @override
  String get purificationGuideGhuslStep3Body =>
      'Хорошо вымой обе руки перед тем, как переходить к остальному телу.';

  @override
  String get purificationGuideGhuslStep4Title =>
      'Вымыть интимные части и удалить видимые нечистоты';

  @override
  String get purificationGuideGhuslStep4Body =>
      'Очисти интимные части и удали видимые нечистоты, пока эта область не станет чистой.';

  @override
  String get purificationGuideGhuslStep5Title => 'Сделать вуду';

  @override
  String get purificationGuideGhuslStep5Body =>
      'Сделай вуду, или хотя бы его основную форму, прежде чем мыть всё тело.';

  @override
  String get purificationGuideGhuslStep6Title => 'Полить голову водой';

  @override
  String get purificationGuideGhuslStep6Body =>
      'Полей голову водой и убедись, что вода хорошо дошла до кожи головы. Это часто делают несколько раз, например 3.';

  @override
  String get purificationGuideGhuslStep7Title => 'Вымыть всё тело';

  @override
  String get purificationGuideGhuslStep7Body =>
      'Вымой всё тело, обычно начиная с правой стороны, затем левой. Фиксированного числа нет, пока вода доходит везде.';

  @override
  String get purificationGuideGhuslStep8Title =>
      'Убедиться, что вода дошла до каждой части';

  @override
  String get purificationGuideGhuslStep8Body =>
      'Внимательно проверь, чтобы не осталось сухих участков, особенно в скрытых местах и складках тела.';

  @override
  String get purificationGuideFinalNoteTitle => 'Главное различие';
  ...
  String get prayerGuideOneRakaatIntro =>
      'Это руководство показывает весь фарз-намаз целиком. Перелистывайте каждую ракаат по порядку и следуйте молитве шаг за шагом.';
  ...
  String prayerGuideRakaatTitle(Object number) {
    return 'Ракаат $number';
  }

  @override
  String get prayerGuideSubhanaka => 'Субханака';

  @override
  String get prayerGuideSubhanakaDescription =>
      'Произнесите вступительную мольбу после такбира только в первом ракаате.';

  @override
  String get prayerGuideQiyamWithSurahDescription =>
      'Стоя прочитайте Аль-Фатиху, затем ещё одну суру или несколько аятов из Корана.';

  @override
  String get prayerGuideQiyamFatihaOnlyDescription =>
      'Стоя прочитайте в этом ракаате только Аль-Фатиху.';

  @override
  String get prayerGuideTashahhudShortDescription =>
      'Сядьте и прочитайте Ат-Тахийят перед тем как встать на следующий ракаат.';

  @override
  String get prayerGuideTashahhudCompleteDescription =>
      'Сядьте для заключительного ташаххуда, прочитайте Ат-Тахийят и Салават Ибрахимийя, затем произнесите короткую дуа перед таслимом.';

  @override
  String get prayerGuideTashahhudCompleteNote =>
      'После салавата можно добавить короткую дуа перед завершением молитвы таслимом.';
